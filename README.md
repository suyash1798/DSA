...
3. [Find the Value of the Partition](./Greedy/Find-the-Value-of-the-Partition.js)
4. [Largest Merge Of Two Strings](./Greedy/Largest-Merge-Of-Two-Strings.js)
5. [Largest Values From Labels](./Greedy/Largest-Values-From-Labels.js)
6. [Maximize Y Sum by Picking a Triplet of Distinct X Values](./Greedy/Maximize-Y‑Sum-by-Picking-a-Triplet-of-Distinct-X‑Values.js)
7. [Maximum Bags With Full Capacity of Rocks](./Greedy/Maximum-Bags-With-Full-Capacity-of-Rocks.js)
8. [Maximum Length of Pair Chain](./Greedy/Maximum-Length-of-Pair-Chain.js)
9. [Maximum Median Sum of Subsequences of Size 3](./Greedy/Maximum-Median-Sum-of-Subsequences-of-Size-3.js)
10. [Maximum Number of Coins You Can Get](./Greedy/Maximum-Number-of-Coins-You-Can-Get.js)
11. [Maximum Number of Operations to Move Ones to the End](./Greedy/Maximum-Number-of-Operations-to-Move-Ones-to-the-End.js)
12. [Maximum Alternating Sum of Squares](./Greedy/Maximum-Alternating-Sum-of-Squares.js)
13. [Minimum Elements to Add to Form a Given Sum](./Greedy/Minimum-Elements-to-Add-to-Form-a-Given-Sum.js)
14. [Minimum Number of Changes to Make Binary String Beautiful](./Greedy/Minimum-Number-of-Changes-to-Make-Binary-String-Beautiful.js)
15. [Minimum Number of Operations to Make Array Empty](./Greedy/Minimum-Number-of-Operations-to-Make-Array-Empty.js)
16. [Minimum Number of Pushes to Type Word II](./Greedy/Minimum-Number-of-Pushes-to-Type-Word-II.js)
17. [Minimum Processing Time](./Greedy/Minimum-Processing-Time.js)
18. [Minimum Suffix Flips](./Greedy/Minimum-Suffix-Flips.js)
19. [Optimal Partition of String](./Greedy/Optimal-Partition-of-String.js)
20. [Partition Array Such That Maximum Difference Is K](./Greedy/Partition-Array-Such-That-Maximum-Difference-Is-K.js)
21. [Partition Labels](./Greedy/Partition-Labels.js)
22. [Partitioning Into Minimum Number Of Deci Binary Numbers](./Greedy/Partitioning-Into-Minimum-Number-Of-Deci-Binary-Numbers.js)
23. [Queue Reconstruction by Height](./Greedy/Queue-Reconstruction-by-Height.js)
24. [Smallest Palindromic Rearrangement I](./Greedy/Smallest-Palindromic-Rearrangement-I.js)
25. [Time Needed to Rearrange a Binary String](./Greedy/Time-Needed-to-Rearrange-a-Binary-String.js)
...
4. [Find the Prefix Common Array of Two Arrays](./HashMap/Find-the-Prefix-Common-Array-of-Two-Arrays.js)
5. [Finding Pairs With a Certain Sum](./HashMap/Finding-Pairs-With-a-Certain-Sum.js)
6. [Finding the Users Active Minutes](./HashMap/Finding-the-Users-Active-Minutes.js)
7. [First Completely Painted Row or Column](./HashMap/First-Completely-Painted-Row-or-Column.js)
8. [Group the People Given the Group Size They Belong To](./HashMap/Group-the-People-Given-the-Group-Size-They-Belong-To.js)
9. [Longest Balanced Subarray I](./HashMap/Longest-Balanced-Subarray-I.js)
10. [Minimum Deletions to Make String K Special](./HashMap/Minimum-Deletions-to-Make-String-K-Special.js)
11. [Minimum Distance Between Three Equal Elements II](./HashMap/Minimum-Distance-Between-Three-Equal-Elements-II.js)
12. [Minimum Length of String After Operations](./HashMap/Minimum-Length-of-String-After-Operations.js)
13. [Number of Matching Subsequences](./HashMap/Number-of-Matching-Subsequences.js)
14. [Tuple with Same Product](./HashMap/Tuple-with-Same-Product.js)
...
6. [Deepest Leaves Sum](./Tree/Deepest-Leaves-Sum.js)
7. [Delete Nodes And Return Forest](./Tree/Delete-Nodes-And-Return-Forest.js)
8. [Find Bottom Left Tree Value](./Tree/Find-Bottom-Left-Tree-Value.js)
9. [Find Largest Value in Each Tree Row](./Tree/Find-Largest-Value-in-Each-Tree-Row.js)
10. [K th Largest Perfect Subtree Size in Binary Tree](./Tree/K-th-Largest-Perfect-Subtree-Size-in-Binary-Tree.js)
11. [Lowest Common Ancestor of a Binary Search Tree](./Tree/Lowest-Common-Ancestor-of-a-Binary-Search-Tree.js)
12. [Lowest Common Ancestor of a Binary Tree](./Tree/Lowest-Common-Ancestor-of-a-Binary-Tree.js)
